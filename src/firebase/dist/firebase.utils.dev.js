...
exports["default"] = exports.signInWithGoogle = exports.firestore = exports.auth = exports.convertCollectionsSnapshotToMap = exports.addCollectionAndDocuments = exports.createUserProfileDocument = void 0;
  ...
  return regeneratorRuntime.async(function createUserProfileDocument$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          userRef = firestore.doc("users/".concat(userAuth.uid)); // const collectionRef = firestore.collection('users');
